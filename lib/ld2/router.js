...
Router = Backbone.Model.extend({
	...
	methodPost: function(app) {
        ...
        app.post("/save-info.json", Auth.loadAccount, CabinetController.saveInfoAction);
        app.post("/change-email.json", Auth.loadAccount, CabinetController.changeEmailAction);
        app.post("/change-password.json", Auth.loadAccount, CabinetController.changePasswordAction)
	},
